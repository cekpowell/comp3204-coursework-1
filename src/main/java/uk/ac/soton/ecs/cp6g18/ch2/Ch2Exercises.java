...
public class Ch2Exercises {
     ...
     * Exercise 1 - Display Utilities.
     *
     * Opening lots of windows can waste time and space (for example if you wanted to view images on every iteration
     * of a process within a loop). In OpenIMAJ we provide a facility to open a named display so that was can reuse
     * the display referring to it by name. Try to do this with all the images we display in this tutorial. Only 1
     * window should open for the whole tutorial.
     */
    public static void exercise1() throws Exception{
        // creating the named window
        JFrame displayFrame = DisplayUtilities.createNamedWindow("Display", "OpenIMAJ Tutorial: Chapter 2: Exercise 1");

        // running the tutorial using this display frame ...
        ...
        DisplayUtilities.display(image.getBand(0), displayFrame);
        ...
        DisplayUtilities.display(clone, displayFrame);
    ...
    public static void exercise2() throws Exception{
        // creating the named window
        JFrame displayFrame = DisplayUtilities.createNamedWindow("Display", "OpenIMAJ Tutorial: Chapter 2: Exercise 2");

        // loading an image using the ImageUtilities class
        MBFImage image = ImageUtilities.readMBF(new URL("http://static.openimaj.org/media/tutorial/sinaface.jpg"));

        // drawing speech bubbles and borders on top of the image

        image.drawShapeFilled(new Ellipse(700f, 450f, 20f, 10f, 0f), RGBColour.WHITE);
        image.drawShape(new Ellipse(700f, 450f, 20f, 10f, 0f), 2, RGBColour.ORANGE);

        image.drawShapeFilled(new Ellipse(650f, 425f, 25f, 12f, 0f), RGBColour.WHITE);
        image.drawShape(new Ellipse(650f, 425f, 25f, 12f, 0f), 2, RGBColour.ORANGE);

        image.drawShapeFilled(new Ellipse(600f, 380f, 30f, 15f, 0f), RGBColour.WHITE);
        image.drawShape(new Ellipse(600f, 380f, 30f, 15f, 0f), 2, RGBColour.ORANGE);

        image.drawShapeFilled(new Ellipse(500f, 300f, 100f, 70f, 0f), RGBColour.WHITE);
        image.drawShape(new Ellipse(500f, 300f, 100f, 70f, 0f), 2, RGBColour.ORANGE);
